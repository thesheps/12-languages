...
I realise now that I've banged on for quite a while without giving any specifics about language fundamentals etc, but .NET Core is going to be the basis of this language exploration.